view: aggregated_results_testharness {
  ...
  (
    ...
    FROM `cortex-demo-environment.TestHarness_CortexIntelligence.AggregatedResults`
    ...
    dimension: url_field {
      ...
      dimension: alert_dashboard_link{
        ...
        link: {
          ...
          url: "https://cortex.cloud.looker.com/dashboards-next/{{url_field._value}}?Product+Name={{ product_name._value }}&Customer={{customer_name._value}}&Ship+to+Location={{location_dma._value}}"
