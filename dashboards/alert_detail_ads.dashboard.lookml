- dashboard: demand_shaping__alerts_detail_dashboard_ads
  ...
  - title: Google Trends Insights
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: aggregated_results_dev_v2_2.trend,
        ...
        type: linear}, {label: !!null '', orientation: right, series: [{axisId: aggregated_results_dev_v2_2.past_sales_quantity,
            ...
            id: aggregated_results_dev_v2_2.wholesale_quantity_measure, name: Total
              Historical Sales Quantity}, {axisId: aggregated_results_dev_v2_2.demand_plan_after_May,
            id: aggregated_results_dev_v2_2.demand_plan_after_May, name: Total Demand
              Plan}, {axisId: aggregated_results_dev_v2_2.forecast, id: aggregated_results_dev_v2_2.forecast,
            name: Forecast}, {axisId: aggregated_results_dev_v2_2.forecast_lower,
            id: aggregated_results_dev_v2_2.forecast_lower, name: Forecast Lower Bound},
  ...
  - title: KPI
    ...
    fields: [aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions,
      aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend, aggregated_results_dev_v2_2.fifty_two_week_sales_volume]
    sorts: [aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend
        desc]
    limit: 500
    hidden_fields: []
    hidden_points_if_no: []
    ...
    style_aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions: "#3A4245"
    show_title_aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions: true
    title_override_aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions: Avg
      Retail Units Uplift per M Impressions
    title_placement_aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions: below
    value_format_aggregated_results_dev_v2_2.avg_retail_units_lift_per_1k_impressions: ''
    style_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: "#3A4245"
    show_title_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: true
    title_override_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: Avg
      Retail $ Uplift per $ Ad Spend
    title_placement_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: below
    value_format_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: ''
    show_comparison_aggregated_results_dev_v2_2.avg_retail_dollar_lift_per_dollar_ads_spend: false
